...
export const dictionaries: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "onboarding.avatarLabel": "Your avatar",
    "onboarding.avatarHint": "We picked one for you — keep it, or choose a different one.",
    ...
    "settings.push.hint": "Get a notification on this device even when the tab isn't open, for the activity types above.",
    "settings.push.enable": "Enable on this device",
    "settings.push.disable": "Turn off on this device",
    "settings.push.busy": "Working…",
    "settings.push.test": "Send test notification",
    "settings.push.testSent": "Sent — check your notifications.",
    "settings.push.testFailed": "Couldn't send a test notification.",
    "settings.push.denied": "Notifications are blocked for this site in your browser settings — enable them there to turn this on.",
    "settings.push.unsupported": "This browser doesn't support push notifications.",
    "settings.push.unconfigured": "Push notifications aren't set up on this deployment yet.",
    "install.title": "Add 言葉 to your home screen",
    "install.body": "Launches like an app, no browser chrome — and it's how you'll get notifications.",
    ...
    "settings.densityTitle": "Card density",
    "settings.densityHint": "Separate from color theme — controls how much shows on a card by default versus behind a tap to expand.",
    "settings.density.comfortable": "Comfortable",
    "settings.density.comfortableHint": "The AI pragmatic read is shown in full on every card.",
    "settings.density.compact": "Compact",
    "settings.density.compactHint": "The AI pragmatic read is collapsed — tap to expand it.",
  ...
  ja: {
    ...
    "onboarding.avatarLabel": "アバター",
    "onboarding.avatarHint": "ランダムに選んでおきました — このままでも、別のものに変更してもOKです。",
    ...
    "settings.push.hint": "タブを開いていなくても、このデバイスに上記の通知を届けます。",
    "settings.push.enable": "このデバイスで有効にする",
    "settings.push.disable": "このデバイスで無効にする",
    "settings.push.busy": "処理中…",
    "settings.push.test": "テスト通知を送る",
    "settings.push.testSent": "送信しました — 通知をご確認ください。",
    "settings.push.testFailed": "テスト通知を送信できませんでした。",
    "settings.push.denied": "ブラウザの設定でこのサイトの通知がブロックされています。有効にしてから再度お試しください。",
    "settings.push.unsupported": "このブラウザはプッシュ通知に対応していません。",
    "settings.push.unconfigured": "このデプロイではプッシュ通知がまだ設定されていません。",
    "install.title": "言葉をホーム画面に追加",
    "install.body": "アプリのように起動でき、ブラウザの枠もありません。通知を受け取るにも必要です。",
    ...
    "settings.theme.edge": "Edge",
    "settings.densityTitle": "カードの密度",
    "settings.densityHint": "カラーテーマとは別の設定です。カードに何をデフォルトで表示し、何をタップで開く形にするかを決めます。",
    "settings.density.comfortable": "ゆったり",
    "settings.density.comfortableHint": "AIの語用論的な読み解きを、すべてのカードで常に表示します。",
    "settings.density.compact": "コンパクト",
    "settings.density.compactHint": "AIの語用論的な読み解きを折りたたみます — タップで開けます。",
