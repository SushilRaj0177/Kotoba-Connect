...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex h-8 w-8 flex-none items-center justify-center rounded-full bg-ink-bg-input text-ink-text-muted transition hover:bg-ink-bg-hover hover:text-ink-text"
    >
      {isDark ? (
        // Sun
