...
export default function ShareEntryButton({
  ...
  return (
    <button
      ...
      onClick={handleShare}
      title={t("card.share")}
      className="flex h-10 w-10 items-center justify-center rounded-full text-ink-text-muted transition hover:bg-ink-bg-hover hover:text-ink-text active:scale-90"
    >
