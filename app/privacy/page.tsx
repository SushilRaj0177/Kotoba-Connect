  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-2xl px-4 py-10 text-sm text-ink-text sm:px-6">
        {/* h2, not h1 — Navbar already renders the page's one h1 ("Privacy", via its title prop above) */}
        <h2 className="mb-6 text-2xl font-bold text-ink-text-header">Privacy Policy</h2>
